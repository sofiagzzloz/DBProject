    ...
    if request.method == 'POST':
        try:
            ...
            # Handle PDF file upload
                ...
                # Create a new menu for logging purposes
                ...
                try:
                    ...
                    if not extracted_text:
                        ProcessingLog.objects.create(
                            ...
                            error_description='Failed to extract text from PDF'
                        )
                    ...
                    if not structured_data:
                        ProcessingLog.objects.create(
                            ...
                            file_name=uploaded_pdf.name,
                            operation_status='FAILED',
                            error_description='AI processing failed'
                        )
...
def save_menu_data(request):
    ...
    if request.method == 'POST':
        try:
            ...
            # Create processing log for save operation
            ProcessingLog.objects.create(
                menu=menu,
                operation_type='SAVE_MENU',
                operation_status='STARTED'
            )
